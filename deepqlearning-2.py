...
file_path = r"C://Users//Fatma//Desktop//covid_50.csv" 
try:
...
EPS_DECAY = 0.99977 # Yavaş düşüş
N_EPISODES = 20000 # Tablo yerine ağ eğittiğimiz için daha fazla adım gerekir
BATCH_SIZE = 64
TARGET_UPDATE_FREQ = 300 # Hedef ağı kaç adımda bir güncelleyeceğimiz
...
plt.title("Eğitim Sürecinde Toplam Ödül Değişimi")
plt.xlabel("Epizot")
